...
// import "../../WebComponents/v6/Header/NavBar/index.js";
// import "../../WebComponents/v6/Header/index.js";

import "../../WebComponents/v6/index.js";
...
const initHeader = (config = {}) => {
    console.log("aaaaaaaa : ", config.items);

    const header = document.getElementById("header");

    if (!header) return;

    console.log("Before buildNav", document.getElementById("menu"));
    ...
    console.log("After buildNav", document.getElementById("menu"));
